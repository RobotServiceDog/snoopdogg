...
class TrotGaitNode(Node):
    def __init__(self):
        ...
        # --- Parameters ---
        self.step_frequency = self.declare_parameter('step_frequency', 1.0).value    
    ...
    def get_leg_trajectory(self, phase_offset, is_left_side):
        ...
        # if (phase_offset > 1 and not is_left_side):
        #     print(f"stride: {self.current_stride_x}, effective_length: {effective_length}")
